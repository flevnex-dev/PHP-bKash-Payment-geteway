...
$callbackURL = 'http://localhost/project/flevnex/bKash-Payment-geteway/';
...
$response = $client->request(
    'POST',
    $base_url . $version . '/tokenized/checkout/token/grant',
    [
        'json' => [
            'app_key' => $app_key,
...
if (isset($_GET['a'])) {
    ...
    $url = curl_init($base_url . $version . '/tokenized/checkout/create');
...
if (isset($_GET['paymentID'], $_GET['status']) && $_GET['status'] == 'success') {
    ...
    $url = curl_init($base_url . $version . '/tokenized/checkout/execute');
...
<body>
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="./?a=15">Buy Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="./?a=25">Buy Now</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Demo Shop 2023</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
